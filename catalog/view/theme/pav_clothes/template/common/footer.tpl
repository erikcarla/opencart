...
<?php  } ?>	
	...
	<div id="powered"><div class="container"><div class="copyright pull-left">
		...
		<?php } else { ?>
		<?php } ?>
			Demco - Responsive & <a href="http://www.fastcomet.com/free-opencart-themes" title="Free OpenCart Themes">Free OpenCart Themes</a>. Designed by <a href="http://www.fastcomet.com/">FastComet</a>
	</div></div>
</section>
